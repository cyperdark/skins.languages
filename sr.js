export default {
  ...
  notifications: {
    0: 'Обавештење',
    1: 'Запратите нас на овим платформама да бисте добијали обавештења о новим скиновима'
  },
  user_menu: {
    0: 'профил',
    1: 'мој ред за скинове',
    2: 'пријавите се поново',
    3: 'одјави се'
  },
  status: {
    0: 'Ништа није пронађено',
    1: 'Није пронађено',
    2: `Није могуће учитати слику`,
    3: 'Нема слике за учитавање'
  },
  settings: {
    0: 'Settings',
    1: 'Mouse scroll',
