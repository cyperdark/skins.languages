export default {
  ...
  tools: {
    title: 'osu! 스킨 제작 툴 (제가 만든 :) )',
    description: 'cyperdark가 제작한, 유용한 osu! 스킨 제작 툴 모음',
    0: '더 많은 스킨 제작 툴'
  },
  skin_ini: {
    title: 'skin.ini 편집기 - osu! 툴',
    description: '',
    prepare: [
      '비트맵 로드 중',
      '스킨 로드 중',
    ...
    0: 'skin.ini 편집기 에 오신 걸 환영합니다!',
    1: '이곳에서 스킨 미리보기와 함께 콤보 색상, 슬라이더 색상, 폰트 오프셋 등의 변경 사항을 실시간으로 확인할 수 있습니다. 현재는 standard 모드만 지원하고 있습니다.',
    2: '비트맵:',
    3: '비트맵 링크 붙여넣기',
    4: '.osk / .zip 가져오기',
    5: '스킨 폴더 가져오기',
    6: '.osu 파일을 찾을 수 없음',
    7: '지원되지 않는 게임모드입니다. osu 비트맵만 가져올 수 있습니다.',
    8: 'skin.ini를 찾을 수 없음',
    9: '최소 1개의 .osk / .zip 파일을 선택하세요.',
    10: '뷰어 설정',
    11: 'skin.ini 초기화',
    12: 'skin.ini 내보내기',
    13: '무작위 색상 선택 (현재 탭)',
  ...
  contests: {
    title: '공식 osu! 스킨 콘테스트',
    description: '진행 중인/완료된 osu! 콘테스트 목록',
    submit: [
      '제출이 마감되었습니다...',
      '제출이 진행 중입니다...',
      '我要投稿'
