export default {
  ...
  meta: {
    ...
    description: {
      // 0: 'Hanki parhaat osu skinit sivumme suuresta valikoimasta! Meillä on skinejä eri pelimodeille ja kuvasuhteille, sekä jopa teemoja animesta ja top pelaajista. Paranna peliäsi meidän korkealaatuisilla skineillä.',
