export default {
  ...
  skin: {
    ...
    38: 'Добро пожаловать в режим редактирования!',
    39: `Не были здесь до этого? Давайте пройдем небольшое обучение, чтобы раскрыть полный потенциал редактора!`,
    40: '{current} из {max} выполнено',
    41: 'Попозже',
    42: `Пройти обучение`,
    43: 'Поздравляем!',
    44: 'Обучение завершено, теперь вы можете добавлять скины!',
    45: 'uploader'
  },
  drag: {
    0: 'Нажмите',
  ...
  meta: {
    ...
    description: {
      ...
      11: 'Список всех активных/готовых конкурсов осу',
  ...
  tooltips: {
    ...
    13: 'Чтобы отметить правило прочитанным, наведите его поверх него (Желтый означает непрочитанный)'
  },
  lists: {
    screens: {
      0: 'Экран приветствия',
