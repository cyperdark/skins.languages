export default {
  ...
  meta: {
    ...
    description: {
      ...
      3: 'Открийте разнообразност от игрови режими и съотношения на резолюцията на нашия сайт. Изберете от стандартния режим, catch the beat, mania и takio. Намере перфектния изпор за вашите гейминг нужди.',
